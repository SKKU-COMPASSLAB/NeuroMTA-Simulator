...
if __name__ == "__main__":
    ...
    linear1_ofm_b  = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=linear1_ofm.shape,  dtype=linear1_ofm.dtype)
    relu1_ofm_b    = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=relu1_ofm.shape,    dtype=relu1_ofm.dtype)
    ...
    linear2_ofm_b  = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=linear2_ofm.shape,  dtype=linear2_ofm.dtype)
    relu2_ofm_b    = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=relu2_ofm.shape,    dtype=relu2_ofm.dtype)
