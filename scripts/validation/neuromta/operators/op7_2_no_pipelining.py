...
if __name__ == "__main__":
    ...
    ofm1_b  = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=ofm.shape,  dtype=ofm.dtype).allocate() 
    ...
    ofm2_b  = MCA_TensorBuffer(mem_space=main_data_mem_space, shape=ofm.shape,  dtype=ofm.dtype).allocate()
