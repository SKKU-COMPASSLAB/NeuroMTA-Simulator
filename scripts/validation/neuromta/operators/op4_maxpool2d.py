...
if __name__ == "__main__":
    ...
    ifm_b  = MCA_TensorBuffer(mem_space=l1_data_mem_space,   shape=ifm.shape,  dtype=ifm.dtype,  shard_grid=(8, 1), blocked_mapping=False).allocate().update(ifm)
    ofm_b  = MCA_TensorBuffer(mem_space=l1_data_mem_space,   shape=ofm.shape,  dtype=ofm.dtype,  shard_grid=(8, 1), blocked_mapping=False).allocate()
