...
def parse_args():
    ...
    parser.add_argument("--n-cg-conv2d", type=int, default=14, help="Number of core groups to use for Conv2D operator.", dest="n_cg_conv2d")
    parser.add_argument("--n-cg-relu", type=int, default=1, help="Number of core groups to use for ReLU operator.", dest="n_cg_relu")
    parser.add_argument("--n-cg-maxpool", type=int, default=1, help="Number of core groups to use for MaxPool2D operator.", dest="n_cg_maxpool")
    args = parser.parse_args()
    return args

def get_benchmark_name(args):
    return f"L1BUF{args.l1_buf_size}_CV{args.n_cg_conv2d}_RE{args.n_cg_relu}_MP{args.n_cg_maxpool}"
...
if __name__ == "__main__":
    ...
    n_cg_conv2d = args.n_cg_conv2d
    n_cg_relu = args.n_cg_relu
    n_cg_maxpool = args.n_cg_maxpool
    ...
    conv_core_group = MCA_CoreGroup.merge_core_groups(sub_core_groups[0:n_cg_conv2d])
    relu_core_group = MCA_CoreGroup.merge_core_groups(sub_core_groups[n_cg_conv2d:n_cg_conv2d + n_cg_relu])
    maxpool_core_group = MCA_CoreGroup.merge_core_groups(sub_core_groups[n_cg_conv2d + n_cg_relu:n_cg_conv2d + n_cg_relu + n_cg_maxpool])
