...
class Benchmark:
    def __init__(
        ...
        compilation_summary_dir: str=None,
    ):
        self.M: int = M
        self.N: int = N
        self.K: int = K
        ...
        self.compilation_summary_dir: str = compilation_summary_dir
    ...
    def run(self, device: TenstorrentDevice, core_group: MTA_CoreGrid):
        ...
        if self.compilation_summary_dir is not None:
            summary_path = os.path.join(self.compilation_summary_dir, f"{self.signature}.json")
...
class BenchmarkProcess(mp.Process):
    def __init__(self, benchmark: Benchmark, device_config: TenstorrentConfig, core_group_offset: tuple[int, int], core_group_shape: tuple[int, int], return_dict: dict, worker_sem, compilation_summary_dir: str=None):
        super().__init__()
        ...
        self.benchmark.compilation_summary_dir = compilation_summary_dir
...
if __name__ == "__main__":
    ...
    compilation_summary_dir = os.path.join(ROOT_DIR, ".logs", FILE_NAME + "_compilation_summaries")
