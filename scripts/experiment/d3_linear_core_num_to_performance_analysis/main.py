...
if __name__ == "__main__":
    ...
    parser.add_argument('-cw', '--core-group-width', default=4, type=int, help="Width of the core group to use for operator execution (e.g., 4 means using a 4x4 core group)", dest="core_group_width")
    parser.add_argument('-ch', '--core-group-height', default=4, type=int, help="Height of the core group to use for operator execution (e.g., 4 means using a 4x4 core group)", dest="core_group_height")
    parser.add_argument('-cn', '--core-group-num', default=1, type=int, help="Number of parallel groups to split the operator into for execution (e.g., 2 means splitting the operator into 2 groups and executing them in parallel on separate core groups)", dest="core_group_num")
    ...
    core_group_shape = (args.core_group_height, args.core_group_width)
    core_group_num = args.core_group_num
    
    core_group = MCA_CoreGroup.merge_core_groups(device.get_npu_core_group().split(shape=core_group_shape)[:core_group_num])
