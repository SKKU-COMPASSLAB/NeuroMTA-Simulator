...
@jit_prototype
def example_kernel(core: SimpleNPUCore, ifm, wgt, psum, ofm):
    core.mxu_load(psum)
...
if __name__ == "__main__":
    ...
    while not core.is_idle_main:
        update = core.get_remaining_cycles()
        core.update_cycle_time(update)
