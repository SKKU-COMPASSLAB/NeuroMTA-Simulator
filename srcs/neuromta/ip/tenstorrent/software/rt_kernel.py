...
__all__ = [
    "TT_RT_KERNEL_LOCAL_CB_ALLOCATE",
    "TT_RT_KERNEL_LOCAL_CB_DEALLOCATE",
    "TT_RT_KERNEL_LOCAL_BUF_ALLOCATE",
    "TT_RT_KERNEL_LOCAL_BUF_DEALLOCATE",
    "TT_RT_KERNEL_MEM_BUFFER_COPY",
    "TT_RT_KERNEL_TILED_LINEAR_BURST_K",
]


class TT_RT_KERNEL_LOCAL_CB_ALLOCATE(MCA_RuntimeKernel):
...
class TT_RT_KERNEL_LOCAL_CB_DEALLOCATE(MCA_RuntimeKernel):
...
class TT_RT_KERNEL_LOCAL_BUF_ALLOCATE(MCA_RuntimeKernel):
    def __init__(self, core: NPUCore, ref: BufferPointer, page_size: int, n_pages: int):
        super().__init__(core=core)
...
class TT_RT_KERNEL_LOCAL_BUF_DEALLOCATE(MCA_RuntimeKernel):
    def __init__(self, core: NPUCore, ref: BufferPointer):
        super().__init__(core=core)
...
class TT_RT_KERNEL_MEM_BUFFER_COPY(MCA_RuntimeKernel):
