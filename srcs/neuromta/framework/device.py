...
class Device:
    ...
    def run_single_step(self, cycle_resolution: int = 1, event_driven_mode: bool = True):
        if not self.is_initialized:
            raise Exception("[ERROR] Device is not initialized. Please call initialize() before using this method.")
    ...
    def run_kernels(
        ...
        event_driven_mode:  bool = True,  # whether to use event-driven mode (True) or fixed cycle resolution mode (False)
